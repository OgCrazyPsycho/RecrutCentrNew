...
{
    public partial class RegComany : Form
    {
        ...
        private void RegComany_Load(object sender, EventArgs e)
        {
        ...
        private void SingUP_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string querystring = $"insert into Users(name_user, Familia_user, Otchestvo_user, Email_user, password_user, phone, Role_, Skills) values ('{nameUser}','{Familia}','{Otchestvo}','{login}','{password}','{Phone}','Работадатель','Семейный бизнесмен')";
